...
function mh_magazine_customizer($wp_customize) {
    ...
    $wp_customize->add_control('header_top_left', array('label' => esc_html__('Header Bar Content (Top - Left)', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[header_top_left]', 'priority' => 1, 'type' => 'select', 'choices' => array('navigation' => esc_html__('Navigation', 'mh-magazine'), 'date' => esc_html__('Date', 'mh-magazine'), 'ticker' => esc_html__('News Ticker', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
	$wp_customize->add_control('header_top_right', array('label' => esc_html__('Header Bar Content (Top - Right)', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[header_top_right]', 'priority' => 2, 'type' => 'select', 'choices' => array('social' => esc_html__('Social Icons', 'mh-magazine'), 'date' => esc_html__('Date', 'mh-magazine'), 'search' => esc_html__('Search', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
	$wp_customize->add_control('header_bottom_left', array('label' => esc_html__('Header Bar Content (Bottom - Left)', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[header_bottom_left]', 'priority' => 3, 'type' => 'select', 'choices' => array('navigation' => esc_html__('Navigation', 'mh-magazine'), 'date' => esc_html__('Date', 'mh-magazine'), 'ticker' => esc_html__('News Ticker', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
	$wp_customize->add_control('header_bottom_right', array('label' => esc_html__('Header Bar Content (Bottom - Right)', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[header_bottom_right]', 'priority' => 4, 'type' => 'select', 'choices' => array('social' => esc_html__('Social Icons', 'mh-magazine'), 'date' => esc_html__('Date', 'mh-magazine'), 'search' => esc_html__('Search', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
    $wp_customize->add_control('ticker_title', array('label' => esc_html__('Ticker Title', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[ticker_title]', 'priority' => 5, 'type' => 'text'));
    $wp_customize->add_control('ticker_posts', array('label' => esc_html__('Limit Post Number', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[ticker_posts]', 'priority' => 6, 'type' => 'text'));
    $wp_customize->add_control('ticker_cats', array('label'=> esc_html__('Custom Categories (use ID - e.g. 3,5,9):', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[ticker_cats]', 'priority' => 7, 'type' => 'text'));
    $wp_customize->add_control('ticker_tags', array('label' => esc_html__('Custom Tags (use slug - e.g. lifestyle):', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[ticker_tags]', 'priority' => 8, 'type' => 'text'));
    $wp_customize->add_control('ticker_offset', array('label' => esc_html__('Skip Posts (Offset):', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[ticker_offset]', 'priority' => 9, 'type' => 'text'));
	$wp_customize->add_control('ticker_sticky', array('label' => esc_html__('Ignore Sticky Posts', 'mh-magazine'), 'section' => 'mh_magazine_layout_header', 'settings' => 'mh_magazine_options[ticker_sticky]', 'priority' => 10, 'type' => 'checkbox'));
    ...
    $wp_customize->add_control('author_box', array('label' => esc_html__('Author Box', 'mh-magazine'), 'section' => 'mh_magazine_layout_content', 'settings' => 'mh_magazine_options[author_box]', 'priority' => 5, 'type' => 'select', 'choices' => array('enable' => esc_html__('Enable', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
    $wp_customize->add_control('author_contact', array('label' => esc_html__('Author Box Contact', 'mh-magazine'), 'section' => 'mh_magazine_layout_content', 'settings' => 'mh_magazine_options[author_contact]', 'priority' => 6, 'type' => 'select', 'choices' => array('enable' => esc_html__('Enable', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
    $wp_customize->add_control('related_content', array('label' => esc_html__('Related Articles', 'mh-magazine'), 'section' => 'mh_magazine_layout_content', 'settings' => 'mh_magazine_options[related_content]', 'priority' => 7, 'type' => 'select', 'choices' => array('enable' => esc_html__('Enable', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
    $wp_customize->add_control('post_nav', array('label' => esc_html__('Post/Attachment Navigation', 'mh-magazine'), 'section' => 'mh_magazine_layout_content', 'settings' => 'mh_magazine_options[post_nav]', 'priority' => 8, 'type' => 'select', 'choices' => array('enable' => esc_html__('Enable', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
    ...
    $wp_customize->add_control('post_meta_cat', array('label' => esc_html__('Post Meta: Categories', 'mh-magazine'), 'section' => 'mh_magazine_layout_meta', 'settings' => 'mh_magazine_options[post_meta_cat]', 'priority' => 3, 'type' => 'select', 'choices' => array('enable' => esc_html__('Enable', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
    $wp_customize->add_control('post_meta_comments', array('label' => esc_html__('Post Meta: Comment Count', 'mh-magazine'), 'section' => 'mh_magazine_layout_meta', 'settings' => 'mh_magazine_options[post_meta_comments]', 'priority' => 4, 'type' => 'select', 'choices' => array('enable' => esc_html__('Enable', 'mh-magazine'), 'disable' => esc_html__('Disable', 'mh-magazine'))));
...
function mh_magazine_customizer_js() {
	wp_enqueue_script('mh-customizer', get_template_directory_uri() . '/js/mh-customizer.js', array(), '1.0.0', true);
	wp_localize_script('mh-customizer', 'mh_magazine_links', array(
		'title'	=> esc_html__('Helpful Links:', 'mh-magazine'),
		'docsURL' => esc_url('http://www.mhthemes.com/support/documentation-mh-magazine/'),
		'docsLabel'	=> esc_html__('Theme Documentation', 'mh-magazine'),
		'supportURL' => esc_url('http://www.mhthemes.com/support/'),
		'supportLabel' => esc_html__('Support Center', 'mh-magazine')
	));
}
add_action('customize_controls_enqueue_scripts', 'mh_magazine_customizer_js');
