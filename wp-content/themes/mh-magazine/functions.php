...
if (!function_exists('mh_magazine_scripts')) {
	function mh_magazine_scripts() {
		wp_enqueue_style('mh-magazine', get_stylesheet_uri(), false, '3.3.0');
